...
//
//        when(bankOTCStockRepository.findAll()).thenReturn(bank4Stocks);
//
//        // Izvršenje
...
//
//        verify(bankOTCStockRepository, times(1)).findAll();
//    }
//
//    @Test
//    void getAllStocksForBank4EmptyTest() {
//        // Priprema
//        when(bankOTCStockRepository.findAll()).thenReturn(new ArrayList<>());
//
//        // Izvršenje
//        List<MyStockDto> result = banka4OtcService.getAllStocksForBank4();
//
