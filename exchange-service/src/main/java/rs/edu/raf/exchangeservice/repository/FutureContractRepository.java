...
public interface FutureContractRepository extends JpaRepository<FutureContract, Long> {
    ...
    List<FutureContract> findByCompanySellerIdOrCompanyBuyerId(Long id, Long id2);
    List<FutureContract> findBySellerCertificateAndBankCertificate(SellerCertificate sellerCertificate, BankCertificate bankCertificate);
