...
public class MyStockService {
    ...
    public void executeTask() {
        if (ordersToSell.isEmpty()){
            ...
            if (stockOrderSell.getType().equalsIgnoreCase("MARKET")){
                printer(amountToSell,currentPrice);    //TODO: poslati currentPrice*amountToBuy ka Transaction-service
                ...
                if (stockOrderSell.getAmountLeft() <= 0){
                    stockOrderSell.setStatus("FINISHED");
            ...
            if (stockOrderSell.getType().equalsIgnoreCase("LIMIT")){
            ...
            if (stockOrderSell.getType().equalsIgnoreCase("STOP")){
            ...
            if (stockOrderSell.getType().equalsIgnoreCase("STOP-LIMIT")){
                if (currentPrice < stockOrderSell.getStopValue()){
                    stockOrderSell.setType("LIMIT");
                } else {
                    System.out.println("Stop value hasn't been approved ");
